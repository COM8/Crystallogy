...
public class GuiBookThreatDustsEnderDust extends GuiBookBaseInfusionPage {
	//-----------------------------------------------Variabeln:---------------------------------------------
	
	
	//-----------------------------------------------Constructor:-------------------------------------------
	public GuiBookThreatDustsEnderDust() {
	...
	public GuiBookPage getNextPage() {
		return PageRegistry.THREAT_DUSTS_FIRE_DUST_PAGE;
	}
