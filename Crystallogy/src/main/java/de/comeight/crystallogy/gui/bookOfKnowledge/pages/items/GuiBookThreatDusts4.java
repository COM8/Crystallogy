...
public class GuiBookThreatDusts4 extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	public GuiBookThreatDusts4() {
		...
		threatDust = new BookMultiItemRenderer(new ItemStack[]{new ItemStack(ItemHandler.damDust)}, 1000, 5.0F);
		initRecipe();
	}
	...
	private void drawText(){
		GuiBookUtilities.drawTextBox(xPosBook + BORDER_LEFT, yPosBook + 120, WRAPWIDTH, 1.0F, "Damages the target eleven times one damage. The Damage Source is magic.");
	}
