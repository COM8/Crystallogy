...
public class GuiBookCrystalHammer2 extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	private void initRecipe(){
		...
		hG.disableFrame();
		BookButtonCrafting hY = new BookButtonCrafting(getNextButtonId(), new ItemStack(ItemHandler.crystallHammerHead, 1, 3), PageRegistry.CRYSTAL_HAMMER_HEAD_PAGE);
		hY.disableFrame();
		...
		BookButtonCrafting output = new BookButtonCrafting(getNextButtonId(), new ItemStack(ItemHandler.crystallHammer_green), null);
		output.disableFrame();
		recipeGreen = new BookInfusionRecipe(new BookButtonCrafting[]{t, hG, dG, dG, e}, output);
		
		output = new BookButtonCrafting(getNextButtonId(), new ItemStack(ItemHandler.crystallHammer_yellow), null);
		output.disableFrame();
	...
	protected void populateSuggestionsList() {
		...
		suggestionsList.addEntry(new BookButtonCategory(GuiBookPage.getNextButtonId(), 0, 0, null, new ItemStack[]{	new ItemStack(ItemHandler.crystallHammerHead, 1, 0), 
