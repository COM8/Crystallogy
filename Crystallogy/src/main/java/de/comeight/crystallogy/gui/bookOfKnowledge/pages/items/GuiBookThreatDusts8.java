...
public class GuiBookThreatDusts8 extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	public GuiBookThreatDusts8() {
		...
		threatDust = new BookMultiItemRenderer(new ItemStack[]{new ItemStack(ItemHandler.glowDust)}, 1000, 5.0F);
		initRecipe();
	}
	...
	private void drawText(){
		GuiBookUtilities.drawTextBox(xPosBook + BORDER_LEFT, yPosBook + 120, WRAPWIDTH, 1.0F, "Gives the target the Glow Potion Effect for 15 seconds.");
	}
