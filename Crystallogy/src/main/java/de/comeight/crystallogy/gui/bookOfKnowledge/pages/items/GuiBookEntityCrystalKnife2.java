...
public class GuiBookEntityCrystalKnife2 extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	private BookInfusionRecipe recipe;
	
	//-----------------------------------------------Constructor:-------------------------------------------
	public GuiBookEntityCrystalKnife2() {
		super("");
		initRecipe();
	}
	...
	private void initRecipe(){
		...
		k.disableFrame();
		BookButtonCrafting g = new BookButtonCrafting(getNextButtonId(), new ItemStack(Items.IRON_SWORD), null);
		g.disableFrame();
		...
		BookButtonCrafting output = new BookButtonCrafting(getNextButtonId(), new ItemStack(ItemHandler.entityCrystalKnife), null);
		output.disableFrame();
