...
public class GuiBookThreatDusts11 extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	public GuiBookThreatDusts11() {
		...
		threatDust = new BookMultiItemRenderer(new ItemStack[]{new ItemStack(ItemHandler.poisDust)}, 1000, 5.0F);
		initRecipe();
	}
	...
	private void drawText(){
		GuiBookUtilities.drawTextBox(xPosBook + BORDER_LEFT, yPosBook + 120, WRAPWIDTH, 1.0F, "Gives the target the Poison Potion Effect for 15 seconds.");
	}
