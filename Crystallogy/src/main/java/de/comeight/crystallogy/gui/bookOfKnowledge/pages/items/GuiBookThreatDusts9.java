...
public class GuiBookThreatDusts9 extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	public GuiBookThreatDusts9() {
		...
		threatDust = new BookMultiItemRenderer(new ItemStack[]{new ItemStack(ItemHandler.hungDust)}, 1000, 5.0F);
		initRecipe();
	}
	...
	private void drawText(){
		GuiBookUtilities.drawTextBox(xPosBook + BORDER_LEFT, yPosBook + 120, WRAPWIDTH, 1.0F, "Gives the target the Hunger Potion Effect for 15 seconds.");
	}
