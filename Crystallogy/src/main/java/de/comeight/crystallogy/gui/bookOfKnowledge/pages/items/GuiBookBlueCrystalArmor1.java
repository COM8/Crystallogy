...
public class GuiBookBlueCrystalArmor1 extends GuiBookBaseArmorPage1 {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	//-----------------------------------------------Constructor:-------------------------------------------
	public GuiBookBlueCrystalArmor1() {
		super("Blue Crystal Armor:");
	}
	
	//-----------------------------------------------Set-, Get-Methoden:------------------------------------
	@Override
	public GuiBookPage getNextPage() {
		return PageRegistry.BLUE_CRYSTAL_ARMOR_PAGE_2;
	}
	
	@Override
	protected ItemArmor getHelmet() {
		return ItemHandler.armorHelmet_blue;
	}

	@Override
	protected ItemArmor getChestplate() {
		return ItemHandler.armorChestplate_blue;
	}

	@Override
	protected ItemArmor getLeggins() {
		return ItemHandler.armorLeggins_blue;
	}

	@Override
	protected ItemArmor getBoots() {
		return ItemHandler.armorBoots_blue;
	}

	@Override
	protected String getDescription() {
		return "The Blue Crystal Armor, if completely equipped, gives you Night Vision and Water Breathing.";
	}
