...
public class GuiBookThreatDusts7 extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	public GuiBookThreatDusts7() {
		...
		threatDust = new BookMultiItemRenderer(new ItemStack[]{new ItemStack(ItemHandler.fireDust)}, 1000, 5.0F);
		initRecipe();
	}
	...
	private void drawText(){
		GuiBookUtilities.drawTextBox(xPosBook + BORDER_LEFT, yPosBook + 120, WRAPWIDTH, 1.0F, "Let's the target burn for 7 seconds.");
	}
