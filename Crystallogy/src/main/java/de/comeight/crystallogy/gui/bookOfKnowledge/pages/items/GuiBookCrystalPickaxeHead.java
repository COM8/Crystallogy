...
public class GuiBookCrystalPickaxeHead extends GuiBookPageSuggestions {
	//-----------------------------------------------Variabeln:---------------------------------------------
	...
	//-----------------------------------------------Constructor:-------------------------------------------
	public GuiBookCrystalPickaxeHead() {
		super("Crystal Pickaxe Head:");
		
		renderer = new BookMultiItemRenderer(new ItemStack[]{	new ItemStack(ItemHandler.crystalPickaxeHead, 1, 0),
																new ItemStack(ItemHandler.crystalPickaxeHead, 1, 1),
																new ItemStack(ItemHandler.crystalPickaxeHead, 1, 2),
																new ItemStack(ItemHandler.crystalPickaxeHead, 1, 3),}, 1000, 5.0F);
		initRecipe();
	}
	...
	private void initRecipe(){
		...
		BookButtonCrafting dR = new BookButtonCrafting(getNextButtonId(), new ItemStack(ItemHandler.crystalPickaxeHead, 1, 0), null);
		BookButtonCrafting dB = new BookButtonCrafting(getNextButtonId(), new ItemStack(ItemHandler.crystalPickaxeHead, 1, 1), null);
		...
		input = new BookButtonCrafting[][]{	{e,e,e},
											{cB,cB,cB},
											{e,e,e}};
	...
	private void drawText(){
		GuiBookUtilities.drawTextBox(xPosBook + BORDER_LEFT, yPosBook + 120, WRAPWIDTH, 1.0F, "Crystal Pickaxe Heads are crafting components. They're used for crafting Crystal Pickaxes and they exist in four colors:\n"
				+ "-red\n"
				+ "-blue\n"
				+ "-green\n"
				+ "-yellow");
