...
public class CompressorCraftingCategory implements IRecipeCategory {
	//-----------------------------------------------Variabeln:---------------------------------------------
	@Nonnull
	public static final String ID = CrystallogyBase.MODID + ":compressor.JEI";
	@Nonnull
	private static final String TITEL = "Compressor";
	@Nonnull
	...
	//-----------------------------------------------Constructor:-------------------------------------------
	public CompressorCraftingCategory() {
	...
	public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper) {
		...
		if(recipeWrapper instanceof CompressorRecipeJEI){
			CompressorRecipeJEI recipe = (CompressorRecipeJEI) recipeWrapper;
