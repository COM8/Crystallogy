...
public class CustomArmorMaterials {
	...
	public static ArmorMaterial CRYSTALL_HUNTER = EnumHelper.addArmorMaterial("crystal_hunter", CrystallogyBase.MODID + ":hunter", 15, new int[]{2,7,7,4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.0F);
	public static ArmorMaterial CRYSTALL_COMBINED = EnumHelper.addArmorMaterial("crystal_combined", CrystallogyBase.MODID + ":combined", 0, new int[]{0,0,0,0}, 0, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F);
