...
public class InfusionRecipePickaxe extends InfusionRecipe {
	//-----------------------------------------------Variabeln:---------------------------------------------

	
	//-----------------------------------------------Constructor:-------------------------------------------
	public InfusionRecipePickaxe() {
		super("pickaxe", 300);
	}
	...
	public InfusionRecipe getRecipe() {
		return new InfusionRecipePickaxe();
	}
	...
	public ArrayList<ItemStack> getOutputJEI() {
		...
		ret.add(new ItemStack(ItemHandler.crystalPickaxe_red));
		ret.add(new ItemStack(ItemHandler.crystalPickaxe_blue));
		ret.add(new ItemStack(ItemHandler.crystalPickaxe_green));
		ret.add(new ItemStack(ItemHandler.crystalPickaxe_yellow));
		return ret;
	}
	...
	public boolean match(ItemStack centerInput, ItemStack[] ingredients) {
		...
		for (int i = 0; i < ingredients.length; i++) {
			if(ingredients[i] != null){
				if(ingredients[i].getItem() == ItemHandler.crystalPickaxeHead){
		...
		if(head_red == 1 && dust_red == 2){
			output = new ItemStack(ItemHandler.crystalPickaxe_red);
			return true;
		}
		else if(head_blue == 1 && dust_blue == 2){
			output = new ItemStack(ItemHandler.crystalPickaxe_blue);
			return true;
		}
		else if(head_green == 1 && dust_green == 2){
			output = new ItemStack(ItemHandler.crystalPickaxe_green);
			return true;
		}
		else if(head_yellow == 1 && dust_yellow == 2){
			output = new ItemStack(ItemHandler.crystalPickaxe_yellow);
			return true;
		}
